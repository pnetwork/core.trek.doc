vsphere-clone-from-template-win
**********************************
| 创建 vSphere 服务器 (微软作业系统)
| 透过 terraform 创建微软作业系统之 VMware 服务器。

.. code-block:: yaml

    id: vsphere-clone-from-template-win
    schemaVersion: '0.2'
    version: 0.6.0
    title: 创建 vSphere 服务器 (微软作业系统)
    description: 透过 terraform 创建微软作业系统之 VMware 服务器。
