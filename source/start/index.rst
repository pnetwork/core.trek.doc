Introduction
================
Trek 是一個幫助你開發 Marvin 上的自動化開發工具。Pentium Internet (奔騰網路) 提供多種開發環境，你可以透過 clikit 界面或 VScode 擴展開發自動化流程腳本。 
...
* Docker 19.03+
* Python 3.7+
* graphviz 2.42.2+ : 使用指令 :doc:`../../reference/clikit/commands/graph` 時用到。

.. _install_trek:

Installation Trek Clikit
==================================
首先我們要安裝 trek clikit 工具，請使用以下指令安裝 trek：
...
=====================================
成功安裝 trek clikit 工具後，我們需要設置 trek config。
